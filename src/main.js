...
import { initChatUI, loadRecommendedQuestions, appendUserMessage, appendOsmaModeSwitchBox, hideOptionContainers } from './chatUI.js';
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  // This works only inside an `async` function or top-level in a module
  ...
  if (sendButton) {
      sendButton.addEventListener("click", () => {
        ...
        sendMessageStream(); // same logic as pressing Enter
        userInput.value = "";
      });
  }
